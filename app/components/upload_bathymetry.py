...
form = html.Div([
    dbc.Row([
        dbc.Col(
            dbc.FormGroup([
                dbc.Label(html.I(["x", html.Sub("min")]), html_for="x-min"),
                dbc.Input(
                    id="x-min",
                    type="number"
                ),
        ...
        dbc.Col(
            dbc.FormGroup([
                dbc.Label(html.I(["x", html.Sub("max")]), html_for="x-max"),
                dbc.Input(
                    id="x-max",
                    type="number"
                ),
        ...
        dbc.Col(
            dbc.FormGroup([
                dbc.Label(html.I(["y", html.Sub("min")]), html_for="y-min"),
                dbc.Input(
                    id="y-min",
                    type="number"
                ),
        ...
        dbc.Col(
            dbc.FormGroup([
                dbc.Label(html.I(["y", html.Sub("max")]), html_for="y-max"),
                dbc.Input(
                    id="y-max",
                    type="number"
                ),
